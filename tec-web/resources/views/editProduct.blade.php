...
<div class="my-0 overflow-x-auto md:mx-0 xl:mx-8">
    <div class="flex justify-between">
        ...
        <form action={{ route('deleteProduct', [$product->id]) }} method="POST">
            @csrf
            <button type="submit" class="py-2 px-4 bg-red-500 text-red-100 rounded hover:bg-red-600 active:bg-red-700 disabled:opacity-50" id="delete-button">Elimina</button>
        </form>
    </div>
    ...
    <form action="{{ route('editProduct') }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="mt-8 grid lg:grid-cols-2 gap-8 gap-x-16">
            ...
            <div>
                <label for="name" class="text-sm text-gray-700 block mb-1 font-medium">Nome del prodotto</label>
