<x-app-layout>
    ...
    <div class="mx-auto border bg-white">
        <div class="flex flex-col lg:flex-row p-8 mt-8">
            <div class="w-full lg:w-1/2 order-2">
                <div class="flex items-center">
                    <a href="{{ route('new-order') }}" class="button flex text-sm text-gray-700 focus:outline-none"><span class="flex items-center justify-center border-2 border-blue-500 rounded-full h-5 w-5 mr-2">1</span>Contacts</a>
                    <a class="button flex text-sm text-gray-500 ml-8 focus:outline-none" disabled><span class="flex items-center justify-center border-2 border-gray-500 rounded-full h-5 w-5 mr-2">2</span> Shipping</a>
                    <a class="button flex text-sm text-gray-500 ml-8 focus:outline-none" disabled><span class="flex items-center justify-center border-2 border-gray-500 rounded-full h-5 w-5 mr-2">3</span> Payments</a>
                </div>
